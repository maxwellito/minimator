import { afterEach, beforeEach, describe, spyOn, resetAllMocks, it, assert } from '../tests/lib.js';
...
describe('timeago', () => {
    ...
    it('should save state after toggle', () => {
        ...
        theme.initialisation();
        theme.toggleMode();
        const lastSetKeyCall = setKeyMock.calls.pop();
        assert(lastSetKeyCall[0], 'theme');
        assert(lastSetKeyCall[1], ThemeMode.Light);
        const lastSetPropertyCall = setPropertyMock.calls.pop();
